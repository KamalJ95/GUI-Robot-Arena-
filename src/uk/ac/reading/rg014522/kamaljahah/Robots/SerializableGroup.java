...
public  class SerializableGroup extends Parent implements Serializable {
     ...
     */
    public SerializableGroup(Node... children) {
     ...
     * @since JavaFX 8.0
     */
    public SerializableGroup(Collection<Node> children) {
        getChildren().addAll(children);
    }
